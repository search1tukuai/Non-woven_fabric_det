...
```bash
$ python detect_qp.py --source 0  # webcam
                            file.jpg  # image 
                            file.mp4  # video
                            path/  # directory
                            path/*.jpg  # glob
...
```bash
$ python detect_qp.py --source data/images --weights yolov5s.pt --conf 0.25
...
image 1/2 /content/region/data/images/bus.jpg: 640x480 4 persons, 1 bus, Done. (0.010s)
image 2/2 /content/region/data/images/zidane.jpg: 384x640 2 persons, 1 tie, Done. (0.011s)
...
# Model
model = torch.hub.load('ultralytics/region', 'yolov5s')
