...
from algorithm.region.utils.google_utils import gsutil_getsize
from algorithm.region.utils.metrics import fitness
from algorithm.region.utils.torch_utils import init_torch_seeds
...
def check_imshow():
    ...
    try:
        ...
        cv2.imshow('my_test', np.zeros((1, 1, 3)))
        cv2.waitKey(1)
    ...
    for i, d in enumerate(x):  # per image
        if d is not None and len(d):
            ...
            for j, a in enumerate(d):  # per item
                ...
                # cv2.imwrite('my_test%i.jpg' % j, cutout)
